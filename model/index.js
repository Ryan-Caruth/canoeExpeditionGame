...
function collisionOnRock() {
  return `Bang!! Canoe hits a log in the water and splits in half, all of your camping supplies are either at the bottom of the river
   ...
   curl http://localhost:5000/api/inWater?option={grab or land}&paddle={shore, continue or{option =land & paddle=abandoned}}`;
}
...
function waitOnShore() {
  return `Cold, bruised and no food you guys wait on shore for help. The end. Play again: curl http://localhost:5000/api/startGame`;
}
